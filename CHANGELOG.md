...
### Changed
- The CLA check counts a commit whose email is linked to no GitHub account as the pull request author's, who ticks an attestation in the description instead of signing under the commit's name.

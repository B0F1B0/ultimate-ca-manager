...
- Following a redirect handed the operator's credentials to whoever answered it: a webhook's bearer token, a mail provider's OAuth2 secret. They are dropped when the hop changes origin, as the HTTP library does on its own

...
- **Microsoft Intune** -- SCEP challenge validation for Intune-managed devices, one Entra app registration per SCEP profile, with a step-by-step guide in `docs/integrations/intune-scep.md`

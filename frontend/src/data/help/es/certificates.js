    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Automático', text: 'En la emisión y renovación, los archivos vinculados se envían de nuevo y se ejecuta el comando de recarga opcional de ese despliegue; las entregas se encolan con reintentos' },
